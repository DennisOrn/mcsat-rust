...
impl Solver {
    ...
    // fn sat(&self) -> Option<Rule> {
    //     if self.trail.is_satisfied(&self.clauses) {
    //         return Some(Rule::Sat);
    //     }
    //     None
    // }

    // fn resolve(&self) -> Option<Rule> {
    //     match &self.state {
    ...
    //                             return Some(Rule::Resolve(new_conflict));
    //                         }
    //                     }
    //                 }
    //                 _ => (),
